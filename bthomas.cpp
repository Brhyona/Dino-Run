    ...
    if(!start) {		 
	  ...
	  glEnd();
         ...
         glBindTexture(GL_TEXTURE_2D, g.tex.playbuttonTexture);
          glBegin(GL_QUADS);
          glTexCoord2f(g.tex.xc2[0], g.tex.yc[1]);
           glVertex2i(g.xres/2 - button_width, g.yres/4 - button_height);
          glTexCoord2f(g.tex.xc2[0], g.tex.yc[0]); 
          glVertex2i(g.xres/2 - button_width, g.yres/4 + button_height);
          glTexCoord2f(g.tex.xc2[1], g.tex.yc[0]); 
          glVertex2i(g.xres/2 + button_width, g.yres/4 + button_height);
...
if(g.paused) { 
    ...
    glBegin(GL_QUADS);
    glTexCoord2f(g.tex.xc2[0], g.tex.yc[1]); 
    glVertex2i(g.xres/4 - Nbutton_width, g.yres/4 - Nbutton_height);
    glTexCoord2f(g.tex.xc2[0], g.tex.yc[0]);
     glVertex2i(g.xres/4 - Nbutton_width, g.yres/4 + Nbutton_height);
    glTexCoord2f(g.tex.xc2[1], g.tex.yc[0]);
     glVertex2i(g.xres/4 + Nbutton_width, g.yres/4 + Nbutton_height);
...
if(info) {
    ...
    glBindTexture(GL_TEXTURE_2D, g.tex.info_backTexture);
          glBegin(GL_QUADS);
          glTexCoord2f(g.tex.xc2[0], g.tex.yc[1]); 
          glVertex2i(g.xres/2 - info_back_width, g.yres/2 - info_back_Bheight);
          glTexCoord2f(g.tex.xc2[0], g.tex.yc[0]); 
          glVertex2i(g.xres/2 - info_back_width, g.yres/2 + info_back_height);
          glTexCoord2f(g.tex.xc2[1], g.tex.yc[0]); 
          glVertex2i(g.xres/2 + info_back_width, g.yres/2 + info_back_height);
          glTexCoord2f(g.tex.xc2[1], g.tex.yc[1]); 
          glVertex2i(g.xres/2 + info_back_width, g.yres/2 - info_back_Bheight);
    ...
    glBegin(GL_QUADS);
    glTexCoord2f(g.tex.xc2[0], g.tex.yc[1]); 
    glVertex2i(g.xres*3/4 + Nbutton_width, g.yres/8 - Nbutton_height);
    glTexCoord2f(g.tex.xc2[0], g.tex.yc[0]); 
    glVertex2i(g.xres*3/4 + Nbutton_width, g.yres/8 + Nbutton_height);
    glTexCoord2f(g.tex.xc2[1], g.tex.yc[0]); 
    glVertex2i(g.xres*3/4 - Nbutton_width, g.yres/8 + Nbutton_height);
   ...
   glPushMatrix();
    glBegin(GL_QUADS);
    glTexCoord2f(g.tex.xc2[0], g.tex.yc[1]); 
    glVertex2i(g.xres*.6 - Space_width, g.yres*5/7 - Space_height);
    glTexCoord2f(g.tex.xc2[0], g.tex.yc[0]); 
    glVertex2i(g.xres*.6 - Space_width, g.yres*5/7 + Space_height);
    glTexCoord2f(g.tex.xc2[1], g.tex.yc[0]); 
    glVertex2i(g.xres*.6 + Space_width, g.yres*5/7 + Space_height);
    ...
    glBegin(GL_QUADS);
    glTexCoord2f(g.tex.xc2[0], g.tex.yc[1]); 
    glVertex2i(g.xres*0.2 - Space_width, g.yres*5/7 - Space_height);
    glTexCoord2f(g.tex.xc2[0], g.tex.yc[0]);
     glVertex2i(g.xres*0.2 - Space_width, g.yres*5/7 + Space_height);
    glTexCoord2f(g.tex.xc2[1], g.tex.yc[0]); 
    glVertex2i(g.xres*0.2 + Space_width, g.yres*5/7 + Space_height);
    ...
    glBegin(GL_QUADS);
    glTexCoord2f(g.tex.xc2[0], g.tex.yc[1]); 
    glVertex2i(g.xres*0.2 - SpaceB_width, g.yres*4/7 - SpaceB_height);
    glTexCoord2f(g.tex.xc2[0], g.tex.yc[0]); 
    glVertex2i(g.xres*0.2 - SpaceB_width, g.yres*4/7 + SpaceB_height);
    glTexCoord2f(g.tex.xc2[1], g.tex.yc[0]); 
    glVertex2i(g.xres*0.2 + SpaceB_width, g.yres*4/7 + SpaceB_height);
    ...
    glBegin(GL_QUADS);
    glTexCoord2f(g.tex.xc2[0], g.tex.yc[1]); 
    glVertex2i(g.xres*0.6 - Space_width, g.yres*4/7 - Space_height);
    glTexCoord2f(g.tex.xc2[0], g.tex.yc[0]);
     glVertex2i(g.xres*0.6 - Space_width, g.yres*4/7 + Space_height);
    glTexCoord2f(g.tex.xc2[1], g.tex.yc[0]);
     glVertex2i(g.xres*0.6 + Space_width, g.yres*4/7 + Space_height);
    ...
    glBegin(GL_QUADS);
    glTexCoord2f(g.tex.xc2[0], g.tex.yc[1]); 
    glVertex2i(g.xres*0.2 - Space_width, g.yres*3/7 - Space_height);
    glTexCoord2f(g.tex.xc2[0], g.tex.yc[0]); 
    glVertex2i(g.xres*0.2 - Space_width, g.yres*3/7 + Space_height);
    glTexCoord2f(g.tex.xc2[1], g.tex.yc[0]); 
    glVertex2i(g.xres*0.2 + Space_width, g.yres*3/7 + Space_height);
    ...
    glBegin(GL_QUADS);
    glTexCoord2f(g.tex.xc2[0], g.tex.yc[1]); 
    glVertex2i(g.xres*0.5 - control_width, g.yres*6.5/8 -  control_height);
    glTexCoord2f(g.tex.xc2[0], g.tex.yc[0]);
     glVertex2i(g.xres*0.5 - control_width, g.yres*6.5/8 +  control_height);
    glTexCoord2f(g.tex.xc2[1], g.tex.yc[0]);
     glVertex2i(g.xres*0.5 + control_width, g.yres*6.5/8 +  control_height);
...
float pastSecs = std::chrono::duration<float>(currentTime - startTime).count();
...
void Bat::updateSwooping(float deltaTime) {
    ...
    if(isSwooping) {
        //std::cout << "performing swoop," << std::endl;
...
void Bat::performSwoop(float deltaTime) {
    ...
    float progress = sin(swoopAngle);
    float targetX = targetSwoopX;
    float targetY = targetSwoopY;
    //float dx = targetX - x;

    x = x + (targetX - x) * progress * 0.1f;
    y = originalY + (targetY - originalY) * progress;

    y -= SWOOP_AMPLITUDE * sin(swoopAngle);
...
Fireball::Fireball(float startX, float startY,
                float iniX, float iniY)
    :x(startX),
    y(startY),
    velocityX(iniX),
    velocityY(iniY),
...
/*Fireball::~Fireball() {
 ...
 void Fireball::update() {
    if(!active) {
     //std::cout << "fireball is inactive" << std::endl;   
        return;
    }
    x += velocityX;
    y += velocityY;
...
void Bat::shootFireball() {
    ...
    double timeDiff = timespec_to_double(&currentTime) - timespec_to_double(&lastFireTime);
...
bool Fireball::checkCollision(const Player& player) const {
 if(!active || hasDamaged) return false;
float circleX = x;
float circleY = y;
...
void Bat::checkFireCollision(Player& player) {
    for(auto& fireball : fireballs) {
        if(fireball.isActive() && !fireball.hasDamaged && fireball.checkCollision(player)) {
            player.takeDamage(Fireball::DAMAGE_AMOUNT);
           
        //std::cout << "player hit" << player.playerHealth.GetCurrentHealth() << std::endl;
